<?php
/**
 * Template Name: Series Name Archive
 * The template for displaying comic archives pages without branding.
 * This template provides an overview to peruse all stories.
