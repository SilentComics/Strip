...
SilentComics is a WordPress theme designed for [SILENT COMICS site](http://silent-comics.com). The theme is still in development and released under the GNU General Public License.
...
SilentComics includes support for Infinite Scroll in Jetpack, and support for WooCommerce.
