...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<div class="entry-wrap wrap clear">
		...
		<?php silentcomics_entry_meta(); ?>
			...
			<span class="entry-format"><a href="<?php echo esc_url( get_post_format_link( 'chat' ) ); ?>" title="<?php echo esc_attr( sprintf( __( 'All %s posts', 'silentcomics' ), get_post_format_string( 'chat' ) ) ); ?>"><?php echo get_post_format_string( 'chat' ); ?></a></span>
