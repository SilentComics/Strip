		...
		<main id="main" class="site-main" role="main">
			...
			<section class="error-404 not-found">
				<header class="page-header">
					<h1 class="page-title"><?php _e( 'Oops! That page can&rsquo;t be found.', 'silentcomics' ); ?></h1>
				</header><!-- .page-header -->
				...
				<div class="page-content">
					...
					<?php if ( silentcomics_categorized_blog() ) : // Only show the widget if site has multiple categories. ?>
