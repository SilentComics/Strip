<?php
/**
 * The template for displaying the Category "Exile" pages
...
<?php // Create and run first loop in reverse order (compare this with the code in category.tofu.php & category.fedor.php
    $comic = new WP_Query();
    $comic->query('post_type=comic&array$paged&posts_per_page=-1&category_name=exile&orderby=title&order=asc');
